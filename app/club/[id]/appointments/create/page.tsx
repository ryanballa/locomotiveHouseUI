...
function CreateClubAppointmentContent() {
  ...
  }, [user, clubId, hasAccessToClub, isSuperAdmin, clubCheckLoading]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!lhUserId) {
        setError(
          "User ID not found. Please ensure your account is properly set up."
        );
        return;
      }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                {(formData.duration / 60).toFixed(1)} hours)
              </label>
              <input
                type="range"
                id="duration"
